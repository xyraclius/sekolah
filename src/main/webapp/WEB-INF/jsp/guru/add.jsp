...
<form id="form-guru" method="post">
	<div class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-md-6">			
				<div class="form-inline">
					<input  id="jk1" name= "jk" type="radio" value="pria" class="radio"  required="required">pria
					<input  id="jk2" name= "jk"  type="radio" value="wanita" class="radio" required="required">wanita
				</div>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-6">
				<textarea rows="5" cols="30" class="form-control" id="alamat" name="alamat"></textarea>
			</div>
		</div>
