		...
		<div class="form-group">
			...
			<div class="col-md-6">
				<input type="text" id="nip" name="nip" 
					class="form-control"  style="background-color: white; border: none;" value="${guru.nip}" readonly="readonly">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-6">
				<input type="text" id="noTelp" name="noTelp"
					class="form-control" required="required" style="background-color: white; border: none" value="${guru.noTelp}" readonly="readonly">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-6">
				<input type="text" id="gelar" name="gelar"
					class="form-control" required="required" style="background-color: white; border: none" value="${guru.gelar}" readonly="readonly">
			</div>
		</div>
