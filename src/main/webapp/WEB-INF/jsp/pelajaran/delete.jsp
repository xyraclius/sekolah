<form id="form-pelajaran" method="post">
	<div class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-md-6">
				<input type="text" id="kdPelajaran" name="kdPelajaran" 
					class="form-control" style="background-color: white; border: none" value="${pelajaran.kdPelajaran}">
			</div>
		</div>
		...
		<div class="form-group">
			<label class="col-md-10">Apakah anda yakin akan menghapus data Pelajaran ${pelajaran.nmPelajaran} ?</label>					
		</div>
